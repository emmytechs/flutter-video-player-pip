...
class AVFoundationVideoPlayer extends VideoPlayerPlatform {
  ...
  Future<void> setPictureInPictureOverlayRect({
    ...
    return _playerWith(id: playerId).setPictureInPictureOverlayRect(rect);
  }
...
class _PlayerInstance {
  ...
  Future<void> setAutomaticallyStartPictureInPicture(bool enable) =>
      _api.setAutomaticallyStartPictureInPicture(enable);

  Future<void> setPictureInPictureOverlayRect(Rect rect) =>
      _api.setPictureInPictureOverlayRect(
  ...
  void _onStreamEvent(dynamic event) {
    ...
    _eventStreamController.add(switch (map['event']) {
      ...
      'startingPictureInPicture' => VideoEvent(
        eventType: VideoEventType.startingPictureInPicture,
      ),
