...
class PictureInPictureOverlayRect {
  ...
  bool operator ==(Object other) {
    if (other is! PictureInPictureOverlayRect || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(top, other.top) && _deepEquals(left, other.left) && _deepEquals(width, other.width) && _deepEquals(height, other.height);
  }
...
class VideoPlayerInstanceApi {
  ...
  Future<int> getLiveOffset() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.getLiveOffset$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setAutomaticallyStartPictureInPicture(bool enable) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.setAutomaticallyStartPictureInPicture$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setPictureInPictureOverlayRect(PictureInPictureOverlayRect rect) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.setPictureInPictureOverlayRect$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[rect]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
