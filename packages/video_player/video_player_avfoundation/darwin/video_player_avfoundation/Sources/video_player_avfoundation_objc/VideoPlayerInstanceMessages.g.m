...
@interface FVPPictureInPictureOverlayRect ()
+ (FVPPictureInPictureOverlayRect *)fromList:(NSArray<id> *)list;
+ (nullable FVPPictureInPictureOverlayRect *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FVPPictureInPictureOverlayRect
+ (instancetype)makeWithTop:(double )top
    left:(double )left
    width:(double )width
    height:(double )height {
  FVPPictureInPictureOverlayRect* pigeonResult = [[FVPPictureInPictureOverlayRect alloc] init];
...
+ (nullable FVPPictureInPictureOverlayRect *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FVPPictureInPictureOverlayRect fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.top),
...
- (BOOL)isEqual:(id)object {
  ...
  FVPPictureInPictureOverlayRect *other = (FVPPictureInPictureOverlayRect *)object;
  return (self.top == other.top || (isnan(self.top) && isnan(other.top))) && (self.left == other.left || (isnan(self.left) && isnan(other.left))) && (self.width == other.width || (isnan(self.width) && isnan(other.width))) && (self.height == other.height || (isnan(self.height) && isnan(other.height)));
}
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    case 129: 
      return [FVPPictureInPictureOverlayRect fromList:[self readValue]];
    case 130: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FVPPictureInPictureOverlayRect class]]) {
    [self writeByte:129];
...
void SetUpFVPVideoPlayerInstanceApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPVideoPlayerInstanceApi> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.getLiveOffset", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(liveOffset:)], @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to @selector(liveOffset:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        NSNumber *output = [api liveOffset:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.setAutomaticallyStartPictureInPicture", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutomaticallyStartPictureInPicture:error:)], @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to @selector(setAutomaticallyStartPictureInPicture:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        BOOL arg_enable = [GetNullableObjectAtIndex(args, 0) boolValue];
        FlutterError *error;
        [api setAutomaticallyStartPictureInPicture:arg_enable error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.VideoPlayerInstanceApi.setPictureInPictureOverlayRect", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setPictureInPictureOverlayRect:error:)], @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to @selector(setPictureInPictureOverlayRect:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        FVPPictureInPictureOverlayRect *arg_rect = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api setPictureInPictureOverlayRect:arg_rect error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
