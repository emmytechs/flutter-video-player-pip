...
@class FVPPictureInPictureOverlayRect;
@class FVPMediaSelectionAudioTrackData;

/// The rect for the picture in picture overlay.
@interface FVPPictureInPictureOverlayRect : NSObject
...
- (void)setAutomaticallyStartPictureInPicture:(BOOL)enable error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setPictureInPictureOverlayRect:(FVPPictureInPictureOverlayRect *)rect error:(FlutterError *_Nullable *_Nonnull)error;
