...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> initialize() async {
    ...
    void eventListener(platform_interface.VideoEvent event) {
      ...
      switch (event.eventType) {
        ...
        case platform_interface.VideoEventType.startingPictureInPicture:
          value = value.copyWith(isPictureInPictureActive: true);
        case platform_interface.VideoEventType.stoppedPictureInPicture:
  ...
  /// Returns true if picture in picture is supported on the current device.
  Future<bool> isPictureInPictureSupported() =>
      _videoPlayerPlatform.isPictureInPictureSupported();

  /// Enable/disable to start picture in picture automatically when the app
