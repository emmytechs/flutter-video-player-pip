...
data class PictureInPictureStartedEvent (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PictureInPictureStartedEvent {
      return PictureInPictureStartedEvent()
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as PictureInPictureStartedEvent
    return true
  }
...
data class PictureInPictureStoppedEvent (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PictureInPictureStoppedEvent {
      return PictureInPictureStoppedEvent()
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as PictureInPictureStoppedEvent
    return true
  }
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
    ...
    return when (type) {
      ...
      131.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          PictureInPictureStartedEvent.fromList(it)
        }
      }
      132.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          PictureInPictureStoppedEvent.fromList(it)
        }
      }
      133.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is PictureInPictureStartedEvent -> {
        stream.write(131)
        writeValue(stream, value.toList())
      }
      is PictureInPictureStoppedEvent -> {
        stream.write(132)
        writeValue(stream, value.toList())
      }
...
interface VideoPlayerInstanceApi {
  ...
  fun setAutomaticallyStartPictureInPicture(enabled: Boolean)
  /** Provides a source rect hint for the PiP animation origin (in screen coordinates). */
  fun setPictureInPictureSourceRectHint(left: Double, top: Double, width: Double, height: Double)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: VideoPlayerInstanceApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.startPictureInPicture$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              api.startPictureInPicture()
              listOf(null)
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.stopPictureInPicture$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setAutomaticallyStartPictureInPicture$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val enabledArg = args[0] as Boolean
            val wrapped: List<Any?> = try {
              api.setAutomaticallyStartPictureInPicture(enabledArg)
              listOf(null)
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setPictureInPictureSourceRectHint$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            ...
            val wrapped: List<Any?> = try {
              api.setPictureInPictureSourceRectHint(leftArg, topArg, widthArg, heightArg)
              listOf(null)
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
