...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(130);
      writeValue(buffer, value.index);
    }    else if (value is PictureInPictureStartedEvent) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
    }    else if (value is PictureInPictureStoppedEvent) {
      buffer.putUint8(132);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 131:
        return PictureInPictureStartedEvent.decode(readValue(buffer)!);
      case 132:
        return PictureInPictureStoppedEvent.decode(readValue(buffer)!);
      case 133:
...
class VideoPlayerInstanceApi {
  ...
  Future<void> startPictureInPicture() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.startPictureInPicture$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> stopPictureInPicture() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.stopPictureInPicture$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setAutomaticallyStartPictureInPicture(bool enabled) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setAutomaticallyStartPictureInPicture$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setPictureInPictureSourceRectHint(double left, double top, double width, double height) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setPictureInPictureSourceRectHint$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[left, top, width, height]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
