...
#if TARGET_OS_IOS
/// The invisible AVPlayerLayer used as the PiP source (opacity 0.001, added to root view).
@property(nonatomic, nullable) AVPlayerLayer *pipPlayerLayer;
/// The PiP controller. Nil when PiP is not supported on the device.
@property(nonatomic, nullable) AVPictureInPictureController *pictureInPictureController;
/// Whether PiP is currently started.
